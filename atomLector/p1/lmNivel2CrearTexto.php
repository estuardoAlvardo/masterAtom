  ...
  background-color:#ffffff;
      ...
      <div class="col-md-8 col-xs-8 pag-center">
        ...
        <h3 style="margin-top: 50px;">Soy Creativo- Crea Tú Cuento</h4>
         ...
         <div class="row">
<a href="<?php echo 'mostrarLect1.php?idLectura='.$_GET['idLectura'].'&gradoB='.$_GET['gradoB'] ?>" class="btn botonAgg-1" style="color: white; background-color: #3498db;">Regresar a la lectura</a>
          <?php

          if($hayonohay==0){ ?>

            <div class="col-md-11 col-xs-11 card" style="margin-top:100px;">
              <div class="row">
                <div class="col-md-2">
                  <img src="../../img/task/wave.gif" style="width:150px; height: 150px;">
              </div>
              <div class="col-md-10">
                <h1>La actividad aun no está disponible! </h1>
                <p><span style="font-size: 13pt">Motivo: aun no es el día que corresponde la lectura.</span></p>
        ...
        <?php } while(@$row1=$mostrarRecursosNivel2->fetch(PDO::FETCH_ASSOC)){?> 
           ...
           <div class="col-md-12">
                    ...
                    <h3>Instrucciones: Crea un cuento utilizando como ayuda la imagen, colocale título.
                      ...
                      <img class="card-style" src="<?php echo $_SESSION['uri'].$row1['direccionImg']; ?>" style="max-width:400px; max-height: 400px; margin-left: 25%; border-radius: 5px;">     
